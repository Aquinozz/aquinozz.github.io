...
const data = {
  ...
  projects: [
    ...
    },
    {
      name: 'JobMatch AI',
      tag: 'Running',
      description: 'Site que avalia e gera currículos de forma automática usando IA.',
      tech: ['Python', 'JavaScript', 'FastAPI', 'PyPDF', 'AI'],
      github: 'https://github.com/ks7m/JobMatch-AI',
      demo: null,
